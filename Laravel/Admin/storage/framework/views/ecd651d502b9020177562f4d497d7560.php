...
<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.createcontract'); ?> <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('li_1'); ?> Forms <?php $__env->endSlot(); ?>
        <?php $__env->slot('title'); ?> Codice 1% Form Editors <?php $__env->endSlot(); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="<?php echo e($product->id); ?>" id="productCheckbox_<?php echo e($product->id); ?>" name="selectedProduct">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Giacometti\Skote_Html_Laravel_v4.2.1\Laravel\Admin\resources\views/createcontract.blade.php ENDPATH**/ ?>