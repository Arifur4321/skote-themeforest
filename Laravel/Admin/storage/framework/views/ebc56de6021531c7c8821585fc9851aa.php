...
<table id="ContractList" class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo e($contract->contract_name); ?></td>
            <td><?php echo e($contract->logged_in_user_name); ?></td>
            ...
            <td>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- Edit action -->
                        <a href="#" class="dropdown-item edit-list" onclick="redirectToEditContract('<?php echo e($contract->id); ?>')">
 ...
 <form action="<?php echo e(route('contracts.index')); ?>" method="GET" class="mb-3">
    <label for="perPage">Items per page:</label>
    <select name="perPage" id="perPage" onchange="this.form.submit()">
        <option value="5" <?php echo e(Request::input('perPage') == 5 ? 'selected' : ''); ?>>5</option>
        <option value="10" <?php echo e(Request::input('perPage') == 10 ? 'selected' : ''); ?>>10</option>
        <option value="20" <?php echo e(Request::input('perPage') == 20 ? 'selected' : ''); ?>>20</option>
        <!-- Add more options as needed -->
    </select>
</form>
<!-- Pagination links -->
<div class="d-flex justify-content-center">
    <?php echo e($contracts->appends(request()->input())->links()); ?>
            ...
            <div class="modal-body">
                <form id="projectForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="project-name-new" value="<?php echo e($contract-> contract_name); ?>">
                    </div>
                    <!-- CKEditor for editing contract content -->
                    <textarea id="editormodal" name="editormodal"><?php echo e($contract->editor_content); ?></textarea>
                </form> 
            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Giacometti\Skote_Html_Laravel_v4.2.1\Laravel\Admin\resources\views/ContractList.blade.php ENDPATH**/ ?>